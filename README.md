...
INSERT A NEW TODOLISTS :
todoapp=# insert into todolists (name) values ('Uncatergorized');

QUERY ALL TODOLISTS RECORDS :
...
INSERT A NEW TODO :
todoapp=# insert into todos (description, completed, list_id) values ('Walk the dog', false, 1);
